...
import HomeDesktop from '../img/HomeDesktop.PNG';
import CurrentTrackDesktop from '../img/CurrentTrackDesktop.PNG';
import TopTracksDesktop from '../img/TopTracksDesktop.PNG';
...
let websiteImages = [HomeDesktop, CurrentTrackDesktop, TopTracksDesktop];
